...
class UserProfileFragment : Fragment() {
    ...
    override fun onViewCreated(
        ...
        val point1 = DailyDataPoint.Present(WeekDay.MONDAY, 100f, 110f)
        val point2 = DailyDataPoint.Present(WeekDay.TUESDAY, 110f, 120f)
        val point3 = DailyDataPoint.Present(WeekDay.WEDNESDAY, 120f, 130f)
        val point4 = DailyDataPoint.Present(WeekDay.THURSDAY, 130f, 140f)
        val point5 = DailyDataPoint.Missing(WeekDay.FRIDAY, 140f)
        val point6 = DailyDataPoint.Present(WeekDay.SATURDAY, 150f, 160f)
        val point7 = DailyDataPoint.Missing(WeekDay.SUNDAY, 140f)
