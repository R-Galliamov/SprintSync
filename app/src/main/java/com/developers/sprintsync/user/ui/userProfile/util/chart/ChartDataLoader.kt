...
class ChartDataLoader {
    ...
    private val point1 = DailyDataPoint.Present(0, 2f, 1.9f)
    private val point2 = DailyDataPoint.Present(1, 2f, 2.3f)
    private val point3 = DailyDataPoint.Present(2, 2f, 2.1f)
    private val point4 = DailyDataPoint.Present(3, 2f, 2.0f)
    private val point5 = DailyDataPoint.Missing(4, 2f)
    private val point6 = DailyDataPoint.Missing(5, 2f)
    private val point7 = DailyDataPoint.Missing(6, 2f)

    private val point8 = DailyDataPoint.Present(7, 2f, 1.9f)
    private val point9 = DailyDataPoint.Present(8, 2f, 2.3f)
    private val point10 = DailyDataPoint.Present(9, 2f, 2.1f)
    private val point11 = DailyDataPoint.Present(10, 2f, 2.0f)
    ...
    private val point15 = DailyDataPoint.Present(15, 2f, 1.9f)
    private val point16 = DailyDataPoint.Present(16, 2f, 2.3f)
    private val point17 = DailyDataPoint.Present(17, 2f, 2.1f)
    private val point18 = DailyDataPoint.Present(18, 2f, 2.0f)
    private val point19 = DailyDataPoint.Missing(19, 2f)
    private val point20 = DailyDataPoint.Missing(20, 2f)
    private val point21 = DailyDataPoint.Missing(21, 2f)
